          ...
          <div className="row align-items-center justify-content-between">
            ...
            <div className="col-xl-5 col-lg-6">
              <div className="product-details-content wow fadeInRight delay-0-2s">
                ...
                <hr className="mb-25" />
                <p>
                  Built for reliability, scalability and ease of adoption,
                  this solution follows modern architecture patterns and
                  maintainable code standards. It is designed to reduce
                  operational risk and improve delivery speed for growing
          ...
          <Tab.Container defaultActiveKey={"details"}>
            ...
            <Tab.Content className="tab-content pb-30 wow fadeInUp delay-0-2s">
              <Tab.Pane className="tab-pane fade" eventKey="details">
                <p>
                  This solution is built with a focus on performance, reliability and maintainability. Our implementation approach combines strong architecture, security best practices and operational readiness for long-term business value.
                </p>
              </Tab.Pane>
              <Tab.Pane className="tab-pane fade" eventKey="information">
                ...
                <p>
                  Our engagement model is outcome-driven, with transparent
                  milestones, clear ownership and dependable post-launch
                  support.
                </p>
              </Tab.Pane>
            </Tab.Content>
              ...
              <div className="product-item wow fadeInUp delay-0-2s">
                ...
                <div className="content">
                  ...
                  <div className="price-details-btn">
                    ...
                    <Link href="/product-details" className="theme-btn">
