            ...
            <div className="col-xl-5 col-lg-6">
              <div className="ww-do-two-content rmb-65 wow fadeInUp delay-0-2s">
                <div className="section-title mb-30">
                  ...
                  <h2>About GUE Engineering Limited</h2>
                </div>
                <p>
                  GUE Engineering Limited is a technology engineering company
                  specializing in software development, AI-powered automation,
                  SaaS solutions, DevOps engineering, cloud infrastructure and
                  technical training.
                </p>
                <div className="row pt-15">
                  <div className="col-sm-6">
                    <div className="feature-item-two border-right pe-sm-3">
                      ...
                      <h5>Innovation Across Africa</h5>
                      <p>
                        We are committed to driving innovation and digital
                        transformation through scalable and secure technology
                        solutions.
                      </p>
                    </div>
                  </div>
                  <div className="col-sm-6">
                    <div className="feature-item-two color-two">
                      ...
                      <h5>Strong Group Backing</h5>
                      <p>
                        As a subsidiary of GUE Group Limited, we build trusted
                        engineering capabilities for enterprises and teams.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-lg-6">
                <div className="feature-item-three wow fadeInRight delay-0-3s">
                  ...
                  <div className="content">
                    ...
                    <p>
                      We deliver practical engineering solutions with measurable business impact
                      from discovery and design to implementation and long-term support
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container pt-130">
          ...
          <Slider {...feedbackActive} className="feedback-active">
            <div className="feedback-item wow fadeInUp delay-0-2s">
              ...
              <h4>Dependable delivery with clear communication</h4>
              <p>
                GUE Engineering delivers measurable outcomes through scalable software systems, reliable cloud operations and expert implementation support.
              </p>
            ...
            <div className="feedback-item wow fadeInUp delay-0-4s">
              ...
              <h4>Custom engineering for complex requirements</h4>
              <p>
                GUE Engineering delivers measurable outcomes through scalable software systems, reliable cloud operations and expert implementation support.
              </p>
              <div className="feedback-author">
            ...
            <div className="feedback-item wow fadeInUp delay-0-6s">
              ...
              <h4>A practical approach that delivers proven results</h4>
              <p>
                GUE Engineering delivers measurable outcomes through scalable software systems, reliable cloud operations and expert implementation support.
              </p>
              <div className="feedback-author">
