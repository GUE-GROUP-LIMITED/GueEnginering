              ...
              <div className="col-xl-4 col-lg-10">
                <div className="pricing-plan-content mb-65 wow fadeInUp delay-0-2s">
                  <div className="section-title mb-30">
                    ...
                    <h2>Choose an Engagement Model</h2>
                  </div>
                  <p>
                    Our pricing structures are tailored to your delivery scope,
                    technical complexity and support needs. Select a model and
                    we will finalize milestones, responsibilities and outcomes
                    during discovery.
                  </p>
                        ...
                        <div className="pricing-plan-three">
                          ...
                          <div className="price-and-btn">
                            <div className="content">
                              ...
                              <Link href="/checkout" className="theme-btn style-three">
                                Choose Package{" "}
