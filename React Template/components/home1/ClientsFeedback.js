            ...
            >
              <div className="testimonial-item-two wow fadeInUp delay-0-2s">
                ...
                <div className="testimonial-content">
                  <p>
                    GUE Engineering helped us streamline delivery and improve
                    release quality with a practical approach tailored to our
                    product roadmap.
                  </p>
              ...
              <div className="testimonial-item-two wow fadeInUp delay-0-4s">
                ...
                <div className="testimonial-content">
                  <p>
                    Their team communicated clearly, delivered on time and
                    exceeded expectations at every project stage.
                  </p>
                  <div className="author-description">
